...
float4 _DefValue = float4(0.809, 0, 1, 0);
...
Texture2D _ShadeMap < string ResourceName = "../Texture2D/t_chr_fktn-base-0000_fce_sdw.png"; >;
Texture2D _RampMap < string ResourceName = "../Texture2D/t_chr_fktn-base-0000_rmp.png"; >;
Texture2D _HighlightMap;
Texture2D _DefMap < string ResourceName = "../Texture2D/t_chr_fktn-base-0000_fce_def.png"; >;
Texture2D _LayerMap < string ResourceName = "../Texture2D/t_chr_fktn-base-0000_fce_lyr.png"; >;
...
v2f vert(appdata v)
{
    ...
    float4x4 _HeadXAxisReflectionMatrix = float4x4(
        float4(-_HeadRightDirection, 0),
        float4(_HeadUpDirection, 0),
        float4(_HeadDirection, 0),
        float4(0, 0, 0, 1)
    );
