...
float4 _DefValue = float4(0.497999996, 0, 1, 0);
...
Texture2D _ShadeMap < string ResourceName = "../Texture2D/t_chr_fktn-base-0000_eye_sdw.png"; >;
Texture2D _RampMap < string ResourceName = "../Texture2D/t_chr_fktn-base-0000_rmp.png"; >;
Texture2D _HighlightMap;
Texture2D _DefMap < string ResourceName = "../Texture2D/t_chr_fktn-base-0000_eye_def.png"; >;
Texture2D _LayerMap;
