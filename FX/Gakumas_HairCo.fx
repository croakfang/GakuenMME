...
float4 _RampAddColor = float4(1, 1, 1, 1);
...
Texture2D _ShadeMap < string ResourceName = "../Texture2D/t_chr_fktn-cstm-0000_hirco_sdw.png"; >;
Texture2D _RampMap < string ResourceName = "../Texture2D/t_chr_fktn-base-0000_rmp.png"; >;
Texture2D _HighlightMap;
Texture2D _DefMap < string ResourceName = "../Texture2D/t_chr_fktn-cstm-0000_hirco_def.png"; >;
Texture2D _LayerMap;
